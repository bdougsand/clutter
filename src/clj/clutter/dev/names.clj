...
(def ^:dynamic clutter-names
  '{floor {:name clutter.api.floor}
    ...
    round {:name clutter.api.round}
    abs {:name clutter.api.abs}
    sin {:name clutter.api.sin}
    cos {:name clutter.api.cos}
    tan {:name clutter.api.tan}

    to-int {:name clutter.api.to-int}

    ;; constant:
    pi {:name clutter.api.pi}
    infinity {:name clutter.api.infinity}})
...
(def clojure-macros (set '[-> ->> ..  and assert case comment cond declare defn defn-
